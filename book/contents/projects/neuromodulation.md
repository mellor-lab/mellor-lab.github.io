...
To test these models, the team measures where and when neuromodulation by acetylcholine, dopamine, noradrenaline and serotonin occurs in the hippocampus during spatial navigation tasks in mice designed to manipulate the type and degree of error and uncertainty. This is a collaborative effort with the groups of Dan Dombeck (Northwestern University, USA) to measure place cell adaptations and Claudia Clopath (Imperial College, UK) to place the findings within a novel theoretical framework.

We are currently recruiting 3 postdoctoral positions and 1 technician to this project.
